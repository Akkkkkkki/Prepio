...
| Practice mode | 4 | 5 | **↑** | **(live)** PREPIO-120 in-session Needs work shipped and toggles correctly on its own. Question-as-hero layout still excellent, controls all 44px+, autosave copy still honest. Back to 5 with the completion-state ratings still in place. PR #233 multi-flag coexistence is shipped in code but **not** live-confirmed — see the "small things worth logging" section; score does not credit coexistence yet. |
