...
baseline and its measurement conditions, expected direction, and (for a
naturally drifting metric) a target or minimum delta — carries onto the Linear
issue so the outcome can be checked after it closes. This mirrors the recurring-hygiene closing condition in
