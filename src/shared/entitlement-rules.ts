// Canonical entitlement contract. Imported by:
//   - src/services/entitlements.ts (frontend, RLS-protected read)
//   - supabase/functions/_shared/entitlement.ts (edge, service-role read)
// Pure, synchronous, no I/O. Contract: docs/BILLING.md.
