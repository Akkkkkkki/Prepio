    ...
    <div className={cn("rounded-2xl border bg-background p-4 shadow-sm space-y-3", className)}>
      ...
      {data.linkedStoryText && (
        <div className="rounded-xl border border-amber-200 bg-amber-50/60 p-3 text-sm">
          <div className="flex items-center gap-2 text-sm font-medium mb-1 text-amber-900">
            <BookOpen className="h-4 w-4 text-amber-600" />
            Draw on your experience
          </div>
          {data.linkedStorySource && (
            <p className="text-xs uppercase text-amber-700 mb-1">{data.linkedStorySource}</p>
          )}
